...
/* ---------- metadata (server export not allowed in "use client",
   so we set noindex via a head tag below) ---------- */
  ...
  return (
    <>
      <head>
        ...
        <title>Dispatch | Colosseum Agent Hackathon</title>
      </head>
        ...
        >
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-text-muted mt-0.5">
                Architecture walkthrough and live E2E flow (2:00 - 2:30)
              </p>
            </div>
          </div>
