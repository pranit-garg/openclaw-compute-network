---
title: Privacy Model
description: How Dispatch enforces privacy through trust pairing and prompt/result stripping for untrusted workers.
---

# Privacy Model

Dispatch treats privacy as a routing-layer concern, not an application-level flag. The coordinator enforces privacy rules — private jobs are only routed to workers you have explicitly trust-paired with.
