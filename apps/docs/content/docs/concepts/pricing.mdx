---
title: Pricing
description: How OpenClaw prices compute jobs — pricing tiers, policy resolution, and the pricing map.
---

# Pricing

Every job in OpenClaw has a price denominated in USD, settled in stablecoins (USDC) via x402 micropayments. Prices are determined by the combination of **policy tier** and **job type**.
