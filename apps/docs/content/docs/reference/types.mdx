...
description: Complete TypeScript type reference for the Dispatch protocol package — enums, interfaces, and utility functions.
---

# TypeScript Types Reference

All shared types are exported from `@dispatch/protocol`. This page documents every enum, interface, and function.
