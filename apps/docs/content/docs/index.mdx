...
Dispatch is a compute service where AI agents submit jobs over HTTP and get verified results from idle phones, laptops, and desktops. Workers earn BOLT on Solana and USDC on Monad for every completed job. Live on Monad testnet and Solana devnet.
