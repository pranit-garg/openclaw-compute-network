---
title: Litepaper
description: "Dispatch: Agent-Native Compute via x402 Payment, ERC-8004 Reputation, and BOLT Token Settlement"
---
...
<a href="https://github.com/pranit-garg/Dispatch/blob/main/docs/Dispatch_Litepaper.pdf" target="_blank" rel="noopener noreferrer">
  **Download the full litepaper (PDF)**
</a>
