---
title: Architecture
description: Deep-dive into the Dispatch Compute Network architecture — coordinators, workers, seekers, and the data flow between them.
---

# Architecture

Dispatch is a three-role system: **seekers** request compute, **coordinators** match and route jobs, and **workers** execute them. Everything communicates over standard HTTP and WebSocket.
