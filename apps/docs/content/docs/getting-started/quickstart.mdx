---
title: Quickstart
description: Get the OpenClaw Compute Network running locally in 5 minutes.
---
...
```bash
git clone https://github.com/openclaw/compute-network.git
cd compute-network
pnpm install
```
...
import { Policy } from "@openclaw/protocol";
